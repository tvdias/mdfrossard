...
<link href="//fonts.googleapis.com/css?family=Source Sans Pro:300,r,i,b,bi|Montserrat:r" rel="stylesheet" type="text/css" />
...
<body class="page-template-default page page-id-1574 op-live-editor-page op-plugin et_bloom">
    <div class="container main-content">
        <div id="content_area" class="">
                ...
                <div class="image-caption" style='width:840px;margin-top:0px;margin-bottom:px;margin-right:auto;margin-left:auto;'><img alt="" src="//www.mdfrossard.com.br/wp-content/uploads/2015/06/Baixe-ebook.webp" border="0" loading="lazy" decoding="async"></div>
